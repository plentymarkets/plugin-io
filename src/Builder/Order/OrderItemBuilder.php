...
class OrderItemBuilder
{
    ...
    /**
     * @param       $basketPrice
     * @param array $subscriptionPrices
     * @return bool
     */
    private function checkSubscriptionPrice($basketPrice, array $subscriptionPrices)
    {
        /** @var \Plenty\Modules\Item\SalesPrice\Models\SalesPriceSearchResponse $subscriptionPrice */
        foreach ($subscriptionPrices as $subscriptionPrice) {
            if($basketPrice == $subscriptionPrice->price) {
                return true;
            }
        }
        return false;
