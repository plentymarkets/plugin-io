...
- Die Performance im Checkout wurde verbessert.

### Behoben

- Beim Widerrufsformular wird die Groß- und Kleinschreibung bei den Eingabefeldern für die Bezeichner nicht mehr beachtet.
- Beim Absenden eines Widerrufsformulars ist keine Einwilligung für Google reCAPTCHA mehr notwendig.
- Buchstaben und Sonderzeichen in der Auftrags-ID werden beim Absenden des Widerrufsformulars nicht mehr entfernt.
...
## v5.0.75 (2025-08-12) <a href="https://github.com/plentymarkets/plugin-io/compare/5.0.74...5.0.75" target="_blank" rel="noopener"><b>Übersicht aller Änderungen</b></a>

### Behoben

- Verbesserte Codequalität und Stabilität mit Rector

## v5.0.74 (2025-06-26) <a href="https://github.com/plentymarkets/plugin-io/compare/5.0.73...5.0.74" target="_blank" rel="noopener"><b>Übersicht aller Änderungen</b></a>
...
- Ein Problem wurde behoben, bei dem Adressen mit Packstationsangaben im "Mein Konto"-Bereich nicht korrekt bearbeitet oder als primär festgelegt werden konnten.
...
- Für die Anzeige des Tracking Links wurde eine zusätzliche Prüfung hinzugefügt, um sicherzustellen, dass der Tracking Link nur für Versanddienstleister mit Tracking-URLs angezeigt wird.
