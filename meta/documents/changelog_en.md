...
## v5.0.83 (2026-09-01) <a href="https://github.com/plentymarkets/plugin-io/compare/5.0.81...5.0.83" target="_blank" rel="noopener"><b>Overview of all changes</b></a>

### Added

- Extended logging for payment method changes.

### Fixed

- Fetching content from external sources, such as a CDN, now follows redirects.

## v5.0.81 (2026-06-18) <a href="https://github.com/plentymarkets/plugin-io/compare/5.0.80...5.0.81" target="_blank" rel="noopener"><b>Overview of all changes</b></a>

### Added

- The performance in the checkout has been improved.
...
- Letters and special characters in the cancellation form's order ID input are no longer removed.
...
- Due to an error during plugin upload, version 5.0.77 was not deployed correctly. This version serves as a replacement.

## v5.0.77 (2025-10-13) <a href="https://github.com/plentymarkets/plugin-io/compare/5.0.76...5.0.77" target="_blank" rel="noopener"><b>Overview of all changes</b></a>

### Fixed

- Added rate limit for password reset request.
...
- A bug was fixed where addresses containing Packstation information could not be properly edited or set as primary in the "My Account" section.
...
- Some functions have been made compatible with PHP 8.2
...
## v5.0.68 (2024-09-26) <a href="https://github.com/plentymarkets/plugin-io/compare/5.0.64...5.0.68" target="_blank" rel="noopener"><b>Overview of all changes</b></a>
